...
import dartie.prefuse.activity.ActivityMap;
...
import dartie.prefuse.data.expression.parser.ExpressionParser;
import dartie.prefuse.data.tuple.CompositeTupleSet;
import dartie.prefuse.data.tuple.DefaultTupleSet;
import dartie.prefuse.data.tuple.TupleManager;
...
import dartie.prefuse.render.RendererFactory;
import dartie.prefuse.util.PrefuseConfig;
import dartie.prefuse.util.PrefuseLib;
import dartie.prefuse.util.collections.CompositeIterator;
import dartie.prefuse.visual.AggregateTable;
import dartie.prefuse.visual.VisualGraph;
import dartie.prefuse.visual.VisualItem;
import dartie.prefuse.visual.VisualTable;
import dartie.prefuse.visual.VisualTree;
import dartie.prefuse.visual.VisualTupleSet;
import dartie.prefuse.visual.expression.ValidatedPredicate;
import dartie.prefuse.visual.expression.VisiblePredicate;
import dartie.prefuse.visual.tuple.TableDecoratorItem;
import dartie.prefuse.visual.tuple.TableEdgeItem;
import dartie.prefuse.visual.tuple.TableNodeItem;
 ...
 * structure (i.e., {@link dartie.prefuse.data.Table}, {@link dartie.prefuse.data.Graph},
 * or {@link dartie.prefuse.data.Tree}), this class takes source data such as that
 ...
 * {@link dartie.prefuse.data.Table}, {@link dartie.prefuse.data.Graph}, or
 * or {@link dartie.prefuse.data.Tree}, a corresponding instance of
 * {@link dartie.prefuse.visual.VisualTable}, {@link dartie.prefuse.visual.VisualGraph}, or
 * {@link dartie.prefuse.visual.VisualTree} is created and stored in the
 ...
 * visual abstraction. Similarly, all {@link dartie.prefuse.data.Tuple},
 * {@link dartie.prefuse.data.Node}, or {@link dartie.prefuse.data.Edge}
 * instances used to represent an entry in the source data have a
 * corresponding {@link dartie.prefuse.visual.VisualItem},
 * {@link dartie.prefuse.visual.NodeItem}, or {@link dartie.prefuse.visual.EdgeItem}
 ...
 * quite useful when crafting {@link dartie.prefuse.action.Action} instances that
 ...
 * {@link dartie.prefuse.data.expression.Predicate} to determine the items to
 ...
 * {@link dartie.prefuse.visual.DecoratorItem} which "decorates" another pre-existing
 * VisualItem with a separate interactive visual object, and
 * {@link dartie.prefuse.visual.AggregateItem} which provides an interactive visual
 ...
 * represented using {@link dartie.prefuse.data.tuple.DefaultTupleSet} instances.
 * Also, some of the interactive controls provided by the
 * {@link prefuse.controls} package populate these sets by default. See
 * {@link dartie.prefuse.controls.FocusControl} for an example.</p>
 * 
 ...
 * filtering {@link dartie.prefuse.data.expression.Predicate} can be used to
 ...
 * {@link dartie.prefuse.visual.expression.InGroupPredicate}). The Visualization's
 ...
 * {@link dartie.prefuse.action.Action} instances that can be invoked to perform
 ...
 * Action's {@link dartie.prefuse.action.Action#run(double)} method. Processing
 ...
 * {@link dartie.prefuse.action.Action} class.</p>
 * 
...
public class Visualization {
     ...
     * @see dartie.prefuse.visual.AggregateTable
     */
     ...
     * realizeed as {@link dartie.prefuse.visual.DecoratorItem} instances that provide
     ...
     * {@link dartie.prefuse.data.tuple.DefaultTupleSet}.
     ...
     * {@link dartie.prefuse.data.expression.parser.ExpressionParser} class. If a
     ...
     * {@link dartie.prefuse.activity.ActivityManager}, which runs in a dedicated
     * thread.
     ...
     * managed by the {@link dartie.prefuse.activity.ActivityManager}, which runs
     ...
     * {@link dartie.prefuse.render.RendererFactory} and returns the result.
     * @param item the item to retreive the renderer for
     * @return the {@link dartie.prefuse.render.Renderer} for drawing the
     * given item
     */
     ...
     * {@link dartie.prefuse.Display#setVisualization(Visualization)} method.

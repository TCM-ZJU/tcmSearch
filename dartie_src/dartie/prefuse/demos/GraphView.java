...
//        overview.addItemBoundsListener(new FitOverviewListener());
    ...
    public static JFrame demo(String uri) {
        return demo("", "name", uri);
    }
    ...
    public static JFrame demo(String datafile, final String label, String uri) {
    	UILib.setPlatformLookAndFeel();
    	Graph g = null;
		try {
/*			IParser parser = ParserFactory.createParser("zhongyijichu.rdf");
			parser.setUri(uri);
			g = new GraphMLReader().readGraph(parser.getInstanceStream());*/
			IParser parser = ParserFactory.createParser("zhongyijichu.rdf", uri);
			g = new GraphMLReader().readGraph(parser.getInstanceStream());

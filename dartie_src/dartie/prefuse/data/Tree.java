 ...
 * tables, and use {@link dartie.prefuse.data.Node} and
 * {@link dartie.prefuse.data.Edge} instances to provide object-oriented access
...
public class Tree extends Graph {
    ...
    /**
     * @see dartie.prefuse.data.Graph#createLinkTable()
     */
    ...
    /**
     * @see dartie.prefuse.data.Graph#updateDegrees(int, int, int, int)
     */

...
import dartie.prefuse.data.parser.DataParseException;
import dartie.prefuse.data.parser.DataParser;
import dartie.prefuse.data.parser.ParserFactory;
...
public class GraphMLReader extends AbstractGraphReader  implements GraphReader {
    ...
    /**
     * @see dartie.prefuse.data.io.GraphReader#readGraph(java.io.InputStream)
     */
...
//                m_edges.setBoolean(m_row, DIRECTED, d);
            ...
            {
                m_uri = atts.getValue(URI);
                m_nodetype =atts.getValue(NODETYPE);
                ...
                String localName, String qName)
        {
            if ( qName.equals(DEFAULT) ) {
                ...
                try {
                    ...
                    Object uri = parse(m_uri, type);
                    Object nodetype = parse(m_nodetype, type);
                    m_table.set(m_row, name, val);
                    m_table.set(m_row, URI, uri);
                    m_table.set(m_row, NODETYPE, nodetype);
        ...
        protected void addToSchema() {
            ...
            try {
                ...
                if ( m_for == null || m_for.equals(ALL) ) {
                    ...
                    m_nsch.addColumn(m_name, type, dflt);
                    m_nsch.addColumn(URI, type, dflt);
                    m_nsch.addColumn(NODETYPE, type, dflt);

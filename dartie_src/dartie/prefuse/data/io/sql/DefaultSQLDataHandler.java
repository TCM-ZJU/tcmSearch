package dartie.prefuse.data.io.sql;
...
public class DefaultSQLDataHandler implements SQLDataHandler {
    ...
    /**
     * @see dartie.prefuse.data.io.sql.SQLDataHandler#process(prefuse.data.Table, int, java.sql.ResultSet, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.io.sql.SQLDataHandler#getDataType(java.lang.String, int)
     */

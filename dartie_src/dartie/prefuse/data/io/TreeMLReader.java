    ...
    public class TreeMLHandler extends DefaultHandler implements Tokens {
        ...
        public void startElement(String namespaceURI, String localName,
            ...
            if ( qName.equals(DECL) ) {
                ...
                m_nodes.addColumn(URI, t);
                m_nodes.addColumn(NODETYPE, t);
            }
        ...
        protected void parseAttribute(Attributes atts) {
            String alName, name = null, value = null, uri = null, nodetype = null;
            for ( int i = 0; i < atts.getLength(); i++ ) {
                ...
                } else if ( alName.equals(URI) ) {
                	uri = atts.getValue(i);
                } else if (alName.equals(NODETYPE) ) {
            ...
            try {
                ...
                m_activeNode.set(URI,uri);
                m_activeNode.set(NODETYPE,nodetype);
            } catch ( Exception e ) {

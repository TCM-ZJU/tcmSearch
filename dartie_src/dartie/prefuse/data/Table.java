...
import dartie.prefuse.data.column.ColumnFactory;
import dartie.prefuse.data.column.ColumnMetadata;
...
import dartie.prefuse.data.tuple.AbstractTupleSet;
...
import dartie.prefuse.data.util.RowManager;
import dartie.prefuse.data.util.TableIterator;
import dartie.prefuse.data.util.TreeIndex;
 ...
 * in an object-oriented fashion using {@link dartie.prefuse.data.Tuple}
 * instances that represent a single row of data in the table. As such,
 * tables implement the {@link dartie.prefuse.data.tuple.TupleSet} interface.</p>
 * 
 ...
 * filtered by providing a {@link dartie.prefuse.data.expression.Predicate},
 ...
 * {@link dartie.prefuse.data.util.Index} instances can be created and retrieved
...
public class Table extends AbstractTupleSet implements ColumnListener {
     ...
     * @see dartie.prefuse.data.tuple.TupleSet#clear()
     */
    public void clear() {
     ...
     * be parsed into an {@link dartie.prefuse.data.expression.Expression} instance.
     * The string is parsed by the
     * {@link dartie.prefuse.data.expression.parser.ExpressionParser}. If an error
     ...
     * @see dartie.prefuse.data.tuple.TupleSet#addTuple(prefuse.data.Tuple)
     */
     ...
     * @return the actual Tuple instance added to this table, or null if
     * no new Tuple has been added
     * @see dartie.prefuse.data.tuple.TupleSet#setTuple(prefuse.data.Tuple)
     */
     ...
     * @see dartie.prefuse.data.tuple.TupleSet#removeTuple(prefuse.data.Tuple)
     */
     ...
     * it does not
     * @see dartie.prefuse.data.tuple.TupleSet#containsTuple(prefuse.data.Tuple)
     */
     ...
     * @see dartie.prefuse.data.tuple.TupleSet#getTupleCount()
     */
     ...
     * @see dartie.prefuse.data.tuple.TupleSet#tuples()
     */
     ...
     * {@link dartie.prefuse.data.util.Index} class.
     ...
     * {@link dartie.prefuse.data.event.EventConstants#ALL_COLUMNS} for operations
     * effecting all columns.
     * @param type the table modification type, one of
     * {@link dartie.prefuse.data.event.EventConstants#INSERT},
     * {@link dartie.prefuse.data.event.EventConstants#DELETE}, or
     * {@link dartie.prefuse.data.event.EventConstants#UPDATE}.
     */

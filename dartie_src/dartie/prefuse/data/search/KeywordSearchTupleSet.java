package dartie.prefuse.data.search;
...
import dartie.prefuse.util.collections.IntObjectHashMap;
...
public class KeywordSearchTupleSet extends SearchTupleSet {
    ...
    /**
     * @see dartie.prefuse.data.search.SearchTupleSet#index(prefuse.data.Tuple, java.lang.String)
     */
     ...
     * @see dartie.prefuse.data.search.SearchTupleSet#isUnindexSupported()
     */
     ...
     * @see dartie.prefuse.data.search.SearchTupleSet#unindex(prefuse.data.Tuple, java.lang.String)
    ...
    /*    d.add(Field.Text(LuceneSearcher.FIELD, text, m_storeTermVectors));
        ...
        d.add(new Field("showContent",text,Field.Store.YES, Field.Index.NO));
        d.add(new Field("showContent",String.valueOf(id),Field.Store.YES, Field.Index.NO));

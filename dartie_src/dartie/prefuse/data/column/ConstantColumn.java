...
public class ConstantColumn extends AbstractColumn {
    ...
    /**
     * Returns false.
     * @see dartie.prefuse.data.column.Column#canSet(java.lang.Class)
     */
    ...
    /**
     * Does nothing.
     * @see dartie.prefuse.data.column.Column#addColumnListener(prefuse.data.event.ColumnListener)
     */
    ...
    /**
     * Does nothing.
     * @see dartie.prefuse.data.column.Column#removeColumnListener(prefuse.data.event.ColumnListener)
     */

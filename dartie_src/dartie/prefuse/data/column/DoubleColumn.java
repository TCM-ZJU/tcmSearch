...
import dartie.prefuse.data.DataReadOnlyException;
import dartie.prefuse.data.DataTypeException;
...
public class DoubleColumn extends AbstractColumn {
    ...
    /**
     * @see dartie.prefuse.data.column.Column#getRowCount()
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#setMaximumRow(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#get(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#set(java.lang.Object, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.AbstractColumn#getDouble(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.AbstractColumn#setDouble(double, int)
     */
...
//    }
    ...
    /**
     * @see dartie.prefuse.data.column.Column#getInt(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#setInt(int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#getLong(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#setLong(long, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#getFloat(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.column.Column#setFloat(float, int)
     */

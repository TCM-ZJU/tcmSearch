 ...
 * {@link dartie.prefuse.data.expression.Predicate} instance for filtering Tuples
...
public abstract class DynamicQueryBinding {
     ...
     * {@link dartie.prefuse.data.event.ExpressionListener} with the
     * {@link dartie.prefuse.data.expression.Predicate} returned by this method.
     * @return the dynamic query {@link dartie.prefuse.data.expression.Predicate}
     */

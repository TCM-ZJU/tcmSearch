...
import dartie.prefuse.data.expression.ComparisonPredicate;
import dartie.prefuse.data.expression.Expression;
import dartie.prefuse.data.expression.Literal;
...
import dartie.prefuse.util.ui.JToggleGroup;
...
public class ListQueryBinding extends DynamicQueryBinding {
     ...
     * @return a {@link dartie.prefuse.util.ui.JToggleGroup} of check boxes bound to
     * this dynamic query.
     ...
     * @return a {@link dartie.prefuse.util.ui.JToggleGroup} of radio buttons bound to
     * this dynamic query.
     */

package dartie.prefuse.data.query;

import javax.swing.JComponent;

import dartie.prefuse.data.Tuple;
import dartie.prefuse.data.event.TupleSetListener;
import dartie.prefuse.data.expression.AbstractPredicate;
...
public class SearchQueryBinding extends DynamicQueryBinding {
     ...
     * @param ts the TupleSet to query
     * @param field the data field (Table column) to query
     * @param set the {@link dartie.prefuse.data.search.SearchTupleSet} to use.
     */
     ...
     * @return the {@link dartie.prefuse.data.search.SearchTupleSet} used by this
     ...
     * @return a {@link dartie.prefuse.util.ui.JSearchPanel} bound to this
     * dynamic query.
     * @see dartie.prefuse.data.query.DynamicQueryBinding#createComponent()
     */

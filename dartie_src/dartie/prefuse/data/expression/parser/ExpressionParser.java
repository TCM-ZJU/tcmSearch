...
package dartie.prefuse.data.expression.parser;

import java.io.StringReader;
import java.util.logging.Logger;

import dartie.prefuse.data.expression.AndPredicate;
import dartie.prefuse.data.expression.ArithmeticExpression;
...
import dartie.prefuse.data.expression.NumericLiteral;
...
import dartie.prefuse.data.expression.XorPredicate;
import dartie.prefuse.util.StringLib;


/**
 * Parser for statements written in the prefuse expression language. Text
 * expression are parsed into {@link dartie.prefuse.data.expression.Expression}
 ...
 * a text String to an {@link dartie.prefuse.data.expression.Expression}, use
 ...
 * write {@link dartie.prefuse.data.expression.Predicate} instances for querying and filtering a table
 ...
 * the {@link dartie.prefuse.data.tuple.TupleSet#tuples(prefuse.data.expression.Predicate)} method
 * uses a Predicate to filter the requested set of tuples, and the
 * {@link dartie.prefuse.data.Table#addColumn(java.lang.String,prefuse.data.expression.Expression)}
 ...
 * {@link dartie.prefuse.render.DefaultRendererFactory},
 * {@link dartie.prefuse.action.assignment.ColorAction},
 * {@link dartie.prefuse.action.assignment.ShapeAction},
 * {@link dartie.prefuse.action.assignment.FontAction}, and
 * {@link dartie.prefuse.action.assignment.SizeAction} classes.
 * </p>
 * <p>
 * The {@link dartie.prefuse.data.expression.Expression} interface is quite simple: given a single
 ...
 * {@link dartie.prefuse.data.expression.parser.ExpressionParser#parse(java.lang.String)}
 ...
 * function by creating a new instance of the {@link dartie.prefuse.data.expression.Function} interface
 * and registering it with the {@link dartie.prefuse.data.expression.FunctionTable} class.
 * </p>
 * <p>
 ...
 *     method. See {@link dartie.prefuse.data.Graph#getSpanningTree()} for more.
 *   </li>
 ...
 *     default method. See {@link dartie.prefuse.data.Graph#getSpanningTree()} for
 *     more.
 *   </li>
 * </ul>
 *

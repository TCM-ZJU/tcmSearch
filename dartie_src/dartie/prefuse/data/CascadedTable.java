...
import dartie.prefuse.data.event.ProjectionListener;
...
import dartie.prefuse.data.util.AcceptAllColumnProjection;
import dartie.prefuse.data.util.CascadedRowManager;
import dartie.prefuse.data.util.ColumnProjection;
 ...
 * a {@link dartie.prefuse.data.expression.Predicate} that filters the parent rows.
 * Columns of the parent table can be selectively included by providing
 * a {@link dartie.prefuse.data.util.ColumnProjection} indicating the columns to
 * include.</p>
 * 
...
public class CascadedTable extends Table {
     ...
     * @see dartie.prefuse.data.util.ValidEdgePredicate
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#getColumnCount()
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#addRow()
     */
    public int addRow() {
        if ( m_parent != null ) {
    ...
    /**
     * @see dartie.prefuse.data.Table#addRows(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#removeRow(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#getColumnName(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#getColumnNumber(prefuse.data.column.Column)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#getColumn(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#hasColumn(java.lang.String)
     */
    ...
    /**
     * @see dartie.prefuse.data.Table#getColumnNames()
     */

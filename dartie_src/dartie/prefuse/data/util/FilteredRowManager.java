...
import dartie.prefuse.data.CascadedTable;
import dartie.prefuse.data.Table;
import dartie.prefuse.data.column.IntColumn;
import dartie.prefuse.util.collections.IntIntSortedMap;
import dartie.prefuse.util.collections.IntIntTreeMap;
...
public class FilteredRowManager extends RowManager {
    ...
    /**
     * @see dartie.prefuse.data.util.RowManager#clear()
     */
    public void clear() {
        super.clear();
    ...
    /**
     * @see dartie.prefuse.data.util.RowManager#releaseRow(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.RowManager#getColumnRow(int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.RowManager#getTableRow(int, int)
     */

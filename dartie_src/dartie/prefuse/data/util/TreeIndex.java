package dartie.prefuse.data.util;

import java.util.Comparator;

import dartie.prefuse.data.Table;
import dartie.prefuse.data.column.Column;
import dartie.prefuse.data.event.ColumnListener;
import dartie.prefuse.data.event.EventConstants;
import dartie.prefuse.data.event.TableListener;
import dartie.prefuse.util.collections.BooleanIntSortedMap;
import dartie.prefuse.util.collections.DoubleIntSortedMap;
import dartie.prefuse.util.collections.FloatIntSortedMap;
import dartie.prefuse.util.collections.IncompatibleComparatorException;
import dartie.prefuse.util.collections.IntIntSortedMap;
import dartie.prefuse.util.collections.IntIterator;
import dartie.prefuse.util.collections.IntSortedMap;
import dartie.prefuse.util.collections.LongIntSortedMap;
import dartie.prefuse.util.collections.ObjectIntSortedMap;
import dartie.prefuse.util.collections.SortedMapFactory;
...
public class TreeIndex implements Index, ColumnListener, TableListener {
    ...
    /**
     * @see dartie.prefuse.data.util.Index#dispose()
     */
    public void dispose() {
    ...
    /**
     * @see dartie.prefuse.data.util.Index#getComparator()
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#size()
     */
    public int size() {
        return m_index.size();
    }
    ...
    /**
     * @see dartie.prefuse.data.util.Index#index()
     */
    public void index() {
        m_index.clear();
    ...
    /**
     * @see dartie.prefuse.data.event.TableListener#tableChanged(prefuse.data.Table, int, int, int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, boolean)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, long)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, float)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, double)
     */
    ...
    /**
     * @see dartie.prefuse.data.event.ColumnListener#columnChanged(prefuse.data.column.Column, int, java.lang.Object)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#minimum()
     */
    public int minimum() {
    ...
    /**
     * @see dartie.prefuse.data.util.Index#maximum()
     */
    public int maximum() {
    ...
    /**
     * @see dartie.prefuse.data.util.Index#median()
     */
    public int median() {
    ...
    /**
     * @see dartie.prefuse.data.util.Index#uniqueCount()
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#allRows(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(java.lang.Object, java.lang.Object, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(int, int, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(long, long, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(float, float, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(double, double, int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(long)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(float)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(double)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(boolean)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#rows(java.lang.Object)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#get(double)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#get(float)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#get(int)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#get(long)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.Index#get(java.lang.Object)
     */

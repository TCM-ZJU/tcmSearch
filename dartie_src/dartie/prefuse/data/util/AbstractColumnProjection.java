...
public abstract class AbstractColumnProjection implements ColumnProjection {
    ...
    /**
     * @see dartie.prefuse.data.util.ColumnProjection#addProjectionListener(prefuse.data.event.ProjectionListener)
     */
    ...
    /**
     * @see dartie.prefuse.data.util.ColumnProjection#removeProjectionListener(prefuse.data.event.ProjectionListener)
     */

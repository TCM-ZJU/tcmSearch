...
public class SpanningTree extends Tree {
     ...
     * @see dartie.prefuse.data.Tree#addChild(int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#addChild(prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#addChildEdge(int, int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#addChildEdge(prefuse.data.Node, prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#addRoot()
     */
    public Node addRoot() {
        throw new UnsupportedOperationException(
            "Changes to tree structure not allowed for spanning trees.");
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#addRootRow()
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#removeChild(int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#removeChild(prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#removeChildEdge(prefuse.data.Edge)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#removeChildEdge(int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Tree#setRoot(prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#addEdge(int, int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#addEdge(prefuse.data.Node, prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#addNode()
     */
    public Node addNode() {
        throw new UnsupportedOperationException(
            "Changes to graph structure not allowed for spanning trees.");
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#addNodeRow()
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#removeEdge(prefuse.data.Edge)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#removeEdge(int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#removeNode(int)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#removeNode(prefuse.data.Node)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#setEdgeTable(prefuse.data.Table)
     */
    ...
    /**
     * Unsupported operation. Spanning trees should not be edited.
     * @see dartie.prefuse.data.Graph#setTupleManagers(prefuse.data.tuple.TupleManager, prefuse.data.tuple.TupleManager)
     */

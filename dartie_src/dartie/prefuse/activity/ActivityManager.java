 ...
 * {@link dartie.prefuse.activity.Activity#run()},
 * {@link dartie.prefuse.activity.Activity#runAt(long)}, and 
 * {@link dartie.prefuse.activity.Activity#runAfter(Activity)}
 * methods. These will automatically call the
 * appropriate methods with the ActivityManager.</p>
 * 
 * <p>For {@link dartie.prefuse.action.Action} instances, one can also register
 * the actions with a {@link dartie.prefuse.Visualization} and use the
 ...
 * @see Activity
 * @see dartie.prefuse.action.Action
 */

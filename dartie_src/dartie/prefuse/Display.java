...
import dartie.prefuse.controls.Control;
...
import dartie.prefuse.util.StringLib;
import dartie.prefuse.util.UpdateListener;
import dartie.prefuse.util.collections.CopyOnWriteArrayList;
import dartie.prefuse.util.display.BackgroundPainter;
import dartie.prefuse.util.display.Clip;
import dartie.prefuse.util.display.DebugStatsPainter;
import dartie.prefuse.util.display.ExportDisplayAction;
import dartie.prefuse.util.display.ItemBoundsListener;
import dartie.prefuse.util.display.PaintListener;
import dartie.prefuse.util.display.RenderingQueue;
import dartie.prefuse.visual.VisualItem;
import dartie.prefuse.visual.expression.VisiblePredicate;
import dartie.prefuse.visual.sort.ItemSorter;
 ...
 * {@link dartie.prefuse.Visualization} from which it pulls the items to visualize.
 * </p>
 * 
 * <p>To control which {@link dartie.prefuse.visual.VisualItem} instances are
 * drawn, the Display also maintains an optional 
 * {@link dartie.prefuse.data.expression.Predicate} for filtering items. The
 * drawing order of items is
 * controlled by an {@link dartie.prefuse.visual.sort.ItemSorter} instance,
 * which calculates a score for each item. Items with higher scores
 * are drawn later, and hence on top of lower scoring items.
 * </p>
 * 
 * <p>The {@link dartie.prefuse.controls.Control Control}
 ...
 * @see Visualization
 * @see dartie.prefuse.controls.Control
...
public class Display extends JComponent {
     ...
     * By default, all {@link dartie.prefuse.visual.VisualItem} instances in the
     ...
     * {@link dartie.prefuse.data.expression.parser.ExpressionParser} to get a
     * {@link dartie.prefuse.data.expression.Predicate} instance.
     * @param visualization the {@link Visualization} backing this Display
     ...
     * Predicate.
     * @param visualization the {@link Visualization} backing this Display
     * @param predicate the filtering {@link dartie.prefuse.data.expression.Predicate}
     */
     ...
     * by this display.
     * @return the filtering {@link dartie.prefuse.data.expression.Predicate}
     */
     ...
     * parsed by the {@link dartie.prefuse.data.expression.parser.ExpressionParser}.
     * If the parse fails or does not result in a
     * {@link dartie.prefuse.data.expression.Predicate} instance, an exception will
     * be thrown.
     */
     ...
     * Sets the filtering Predicate used to control what items are drawn by
     * this Display.
     * @param p the filtering {@link dartie.prefuse.data.expression.Predicate} to use
     */
     ...
     * by the ItemSorter.
     * @return this Display's {@link dartie.prefuse.visual.sort.ItemSorter}
     */
     ...
     * VisualItems. Items are drawn in ascending order of the scores provided
     * by the ItemSorter.
     * @return the {@link dartie.prefuse.visual.sort.ItemSorter} to use
     */
     ...
     * {@link dartie.prefuse.util.io.IOLib#urlFromString(String)} to resolve
     ...
     * @see dartie.prefuse.util.ui.JCustomTooltip
     */
     ...
     * {@link dartie.prefuse.visual.VisualItem#getBounds()} are not accurate and the
     * item's {@link dartie.prefuse.render.Renderer} is drawing outside of the
     ...
     * about paint events.
     * @param pl the {@link dartie.prefuse.util.display.PaintListener} to add
     */
     ...
     * @param pl the {@link dartie.prefuse.util.display.PaintListener} to remove
     */
     ...
     * @param ibl the {@link dartie.prefuse.util.display.ItemBoundsListener} to add
     */
     ...
     * occupied by the VisualItems in this Display change.
     * @param ibl the {@link dartie.prefuse.util.display.ItemBoundsListener} to remove
     */

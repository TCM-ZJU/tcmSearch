 ...
 */
package dartie.prefuse.util.display;
...
import dartie.prefuse.util.io.IOLib;
 ...
 * the {@link dartie.prefuse.Display} class in response to the
 * {@link dartie.prefuse.Display#setBackgroundImage(Image, boolean, boolean)} and
 * {@link dartie.prefuse.Display#setBackgroundImage(String, boolean, boolean)}
 * methods.
 * 
...
public class BackgroundPainter implements PaintListener {
     ...
     * @see dartie.prefuse.util.display.PaintListener#prePaint(prefuse.Display, java.awt.Graphics2D)
     */
    ...
    /**
     * Does nothing.
     * @see dartie.prefuse.util.display.PaintListener#postPaint(prefuse.Display, java.awt.Graphics2D)
     */

package dartie.prefuse.util.force;
...
public abstract class AbstractForce implements Force {
    ...
    /**
     * @see dartie.prefuse.util.force.Force#getParameterCount()
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#getParameter(int)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#getMinValue(int)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#getMaxValue(int)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#getParameterName(int)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#setParameter(int, float)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#setMinValue(int, float)
     */
    ...
    /**
     * @see dartie.prefuse.util.force.Force#setMaxValue(int, float)
     */
    ...
    /**
     * Returns false.
     * @see dartie.prefuse.util.force.Force#isItemForce()
     */
    ...
    /**
     * Returns false.
     * @see dartie.prefuse.util.force.Force#isSpringForce()
     */
     ...
     * @see dartie.prefuse.util.force.Force#getForce(prefuse.util.force.ForceItem)
     */
    ...
    /**
     * Throws an UnsupportedOperationException.
     * @see dartie.prefuse.util.force.Force#getForce(prefuse.util.force.Spring)
     */

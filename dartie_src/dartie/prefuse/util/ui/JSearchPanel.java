    ...
    implements DocumentListener, ActionListener
{
    ...
    private void init(TupleSet source) {
        ...
        m_queryF.setMaximumSize(new Dimension(300, 20));
        m_queryF.setPreferredSize(new Dimension(300, 20));
    ...
    private void initUI() {
        ...
        m_sbox.setMaximumSize(new Dimension(300, 20));
        m_sbox.setPreferredSize(new Dimension(300, 20));
        ...
        if ( m_includeHitCount ) {
            ...
            m_pane.setMaximumSize(new Dimension(400, 100));
            m_pane.setPreferredSize(new Dimension(171, 40));

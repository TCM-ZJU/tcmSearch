 ...
 * {@link dartie.prefuse.data.Graph#getSpanningTree()} method.
 * 
...
public class JPrefuseTree extends JTree {
    ...
    public class PrefuseTreeModel implements TreeModel, GraphListener {
        ...
        /**
         * @see dartie.prefuse.data.event.GraphListener#graphChanged(prefuse.data.Graph, java.lang.String, int, int, int, int)
         */

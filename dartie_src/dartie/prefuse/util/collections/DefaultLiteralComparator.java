...
public class DefaultLiteralComparator implements LiteralComparator {
    ...
    /**
     * @see dartie.prefuse.util.collections.LiteralComparator#compare(int, int)
     */
    ...
    /**
     * @see dartie.prefuse.util.collections.LiteralComparator#compare(long, long)
     */
    ...
    /**
     * @see dartie.prefuse.util.collections.LiteralComparator#compare(float, float)
     */
    ...
    /**
     * @see dartie.prefuse.util.collections.LiteralComparator#compare(double, double)
     */
    ...
    /**
     * @see dartie.prefuse.util.collections.LiteralComparator#compare(boolean, boolean)
     */

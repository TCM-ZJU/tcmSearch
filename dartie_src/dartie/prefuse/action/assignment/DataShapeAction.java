 ...
 * list of shape values is included in the {@link dartie.prefuse.Constants} class,
 ...
 * {@link dartie.prefuse.Constants#SHAPE_COUNT} (when no palette is given) or
 ...
 * into account must be used (e.g., {@link dartie.prefuse.render.ShapeRenderer}).
 * </p>
 * 
...
public class DataShapeAction extends ShapeAction {
     ...
     * codes included in the {@link dartie.prefuse.Constants} class.
     */
    ...
    /**
     * @see dartie.prefuse.action.assignment.ShapeAction#getShape(prefuse.visual.VisualItem)
     */

package dartie.prefuse.action.assignment;
...
import dartie.prefuse.util.ColorMap;
import dartie.prefuse.util.DataLib;
import dartie.prefuse.util.MathLib;
...
public class DataColorAction extends ColorAction {
     ...
     * {@link dartie.prefuse.Constants#NOMINAL}, {@link dartie.prefuse.Constants#ORDINAL},
     * or {@link dartie.prefuse.Constants#NUMERICAL}, for whether the data field
     ...
     * {@link dartie.prefuse.util.ColorLib} for color palette generators.
     */
    public DataColorAction(String group, String dataField, 
     ...
     * {@link dartie.prefuse.Constants#NOMINAL}, {@link dartie.prefuse.Constants#ORDINAL},
     * or {@link dartie.prefuse.Constants#NUMERICAL}.
     ...
     * This value is only used for {@link dartie.prefuse.Constants#NUMERICAL}
     * data.
     * @return the scale type. One of
     * {@link dartie.prefuse.Constants#LINEAR_SCALE},
     * {@link dartie.prefuse.Constants#LOG_SCALE}, 
     * {@link dartie.prefuse.Constants#SQRT_SCALE},
     * {@link dartie.prefuse.Constants#QUANTILE_SCALE}.
     */
    public int getScale() {
        return m_scale;
    }
     ...
     * {@link dartie.prefuse.Constants#NUMERICAL} data.
     * @param scale the scale type to use. This value should be one of
     * {@link dartie.prefuse.Constants#LINEAR_SCALE}, 
     * {@link dartie.prefuse.Constants#SQRT_SCALE},
     * {@link dartie.prefuse.Constants#LOG_SCALE},
     * {@link dartie.prefuse.Constants#QUANTILE_SCALE}.
     * If {@link dartie.prefuse.Constants#QUANTILE_SCALE} is used, the number of
     ...
     * @see dartie.prefuse.action.EncoderAction#setup()
     */
    ...
    /**
     * @see dartie.prefuse.action.assignment.ColorAction#getColor(prefuse.visual.VisualItem)
     */

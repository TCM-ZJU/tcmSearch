...
public class DataSizeAction extends SizeAction {
     ...
     * {@link dartie.prefuse.Constants#QUANTILE_SCALE}. If a quantile scale is
     ...
     *  length sizes.
     * @see dartie.prefuse.util.PrefuseLib#getSize2D(double)
     */
    ...
    /**
     * @see dartie.prefuse.action.EncoderAction#finish()
     */
    ...
    /**
     * @see dartie.prefuse.action.assignment.SizeAction#getSize(prefuse.visual.VisualItem)
     */

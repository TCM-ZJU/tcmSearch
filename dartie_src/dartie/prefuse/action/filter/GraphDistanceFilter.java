...
import dartie.prefuse.data.util.BreadthFirstIterator;
import dartie.prefuse.data.util.FilterIterator;
...
public class GraphDistanceFilter extends GroupAction {
     ...
     * {@link dartie.prefuse.Visualization#FOCUS_ITEMS} group will be used as the

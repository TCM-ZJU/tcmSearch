...
import dartie.prefuse.data.expression.ExpressionVisitor;
import dartie.prefuse.data.expression.ObjectLiteral;
import dartie.prefuse.data.expression.Predicate;
import dartie.prefuse.util.PredicateChain;
...
public abstract class EncoderAction extends ItemAction {
     ...
     * @param vis the {@link dartie.prefuse.Visualization} to process
     ...
     * Create a new EncoderAction that processes the specified group.
     * @param group the name of the group to process
     * @param filter the filtering {@link dartie.prefuse.data.expression.Predicate}
     */
    ...
    /**
     * @see dartie.prefuse.action.Action#setVisualization(prefuse.Visualization)
     */

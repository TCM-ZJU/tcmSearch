package dartie.prefuse.action.layout;
...
import dartie.prefuse.data.query.NumberRangeModel;
import dartie.prefuse.data.query.ObjectRangeModel;
import dartie.prefuse.data.tuple.TupleSet;
import dartie.prefuse.util.DataLib;
import dartie.prefuse.util.MathLib;
import dartie.prefuse.util.ui.ValuedRangeModel;
...
public class AxisLayout extends Layout {
     ...
     * @param group the data group to layout
     * @param field the data field upon which to base the layout
     * @param axis the axis type, either {@link dartie.prefuse.Constants#X_AXIS}
     * or {@link dartie.prefuse.Constants#Y_AXIS}.
     */
     ...
     * {@link dartie.prefuse.util.ui.ValuedRangeModel#getLowValue()} and
     * {@link dartie.prefuse.util.ui.ValuedRangeModel#getHighValue()} methods.
     ...
     * {@link dartie.prefuse.Constants#SQRT_SCALE}, or
     ...
     * {@link dartie.prefuse.Constants#X_AXIS} or {@link dartie.prefuse.Constants#Y_AXIS}.
     ...
     * {@link dartie.prefuse.Constants#NUMERICAL}, or
     * {@link dartie.prefuse.Constants#UNKNOWN}.

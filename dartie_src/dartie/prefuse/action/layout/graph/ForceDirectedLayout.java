package dartie.prefuse.action.layout.graph;

import java.awt.geom.Point2D;
import java.awt.geom.Rectangle2D;
import java.util.Iterator;

import dartie.prefuse.action.layout.Layout;
...
import dartie.prefuse.util.force.DragForce;
import dartie.prefuse.util.force.ForceItem;
import dartie.prefuse.util.force.ForceSimulator;
import dartie.prefuse.util.force.NBodyForce;
import dartie.prefuse.util.force.SpringForce;
 ...
 * this value.</p>
 * 
 * <p>The {@link dartie.prefuse.util.force.ForceSimulator} used to drive this layout
 ...
 * {@link dartie.prefuse.util.force.Force} components. Each node in the layout is
 * mapped to a {@link dartie.prefuse.util.force.ForceItem} instance and each edge
 * to a {@link dartie.prefuse.util.force.Spring} instance for storing the state
...
public class ForceDirectedLayout extends Layout {
     ...
     * @see dartie.prefuse.util.PrefuseLib#setX(VisualItem, VisualItem, double)
     * @see dartie.prefuse.util.PrefuseLib#setY(VisualItem, VisualItem, double)
     */

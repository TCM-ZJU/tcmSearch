 ...
 * is associated with one and only one {@link dartie.prefuse.Visualization}.</p>
 * 
 ...
 * a {@link dartie.prefuse.render.Renderer}, which contains instructions for drawing
 * the item. The Renderer to use for a given item is decided by the
 * {@link dartie.prefuse.render.RendererFactory} associated with the item's
 * backing Visualization.</p>
 * 
 * <p>Finally, actually setting the visual properties of VisualItems is
 * commonly done by the many {@link dartie.prefuse.action.Action} modules available
...
public interface VisualItem extends Tuple {
     ...
     * {@link dartie.prefuse.action.assignment.ColorAction} might assign colors
     * based on the flag).
     ...
     * @see dartie.prefuse.util.ColorLib
     * @see #STROKECOLOR
     */
     ...
     * included in the {@link dartie.prefuse.Constants} class. This value only has an
     * effect if a Renderer that supports different shapes is used
     * (e.g., {@link dartie.prefuse.render.ShapeRenderer}.

...
import dartie.prefuse.visual.AggregateItem;
...
{   
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#getAggregateSize()
     */
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#containsItem(prefuse.visual.VisualItem)
     */
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#addItem(prefuse.visual.VisualItem)
     */
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#removeItem(prefuse.visual.VisualItem)
     */
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#removeAllItems()
     */
    ...
    /**
     * @see dartie.prefuse.visual.AggregateItem#items()
     */

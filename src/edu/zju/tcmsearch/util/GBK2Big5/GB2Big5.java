 ...
 * @version 1.0
 *
 * @see edu.zju.tcmsearch.util.GBK2Big5.StreamConverter
 */
...
public class GB2Big5{
    ...
    public String simple2traditional(String simple,String encoding) throws UnsupportedEncodingException, Exception{
    	String s_gbk = new String(simple.getBytes("gbk"),"gbk");
    	String t_big5 =new String(gb2big5(s_gbk),"big5");
    	String t_gbk  =new String(t_big5.getBytes("gbk"),"gbk");
    	return "gbk".equals(encoding.toLowerCase()) ? t_gbk : new String(t_gbk.getBytes(encoding),encoding);
    }
    ...
    public String get(String simple){
    	try {
			String s_gbk = new String(simple.getBytes("gbk"),"gbk");
	    	String t_big5 =new String(gb2big5(s_gbk),"big5");
			String t_utf = new String(t_big5.getBytes("utf-8"),"utf-8");
			return t_utf;
    ...
    public String simple2traditional(String simple){
